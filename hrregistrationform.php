                    ...
                    <div class="sidebar-textwidget">
                        ...
                        <div class="sidebar-info-contents">
                            <div class="content-inner">
                                <div class="logo">
                                    <a href="#"><img src="img/trividalogored.png" alt="" /></a>
                                </div>
                        ...
                        <aside class="sidebar sticky-top">
                            ...
                            <div class="sidebar-widget contact-widget">
                                <div class="widget-content" style="background-image:url(images/resource/service.jpg)">
                                    ...
                                    <ul>
                                        <li><span class="icon flaticon-call"></span>9755517733</li>
                                        <li><span class="icon flaticon-envelope"></span>contact@trivida.in</li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="content-side right-sidebar col-lg-8 col-md-12 col-sm-12">
                        <div class="services-detail">
                            <div class="inner-box">
                                ...
                                <h3>HR Registration Form</h3>
                                <div class="appointment-form">
                                    <form method="post" action="hrregistrationmail.php" enctype="multipart/form-data">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-12 col-md-6 col-sm-12 form-group">
                                                ...
                                                <input type="radio" name="fav_gender" value="Male">
                                                <label for="Male"> Male</label>
                                                <input type="radio" name="fav_gender" value="Female">
                                                <label for="Female"> Female</label>
                                                <input type="radio" name="fav_gender" value=">Transgender">
                                                <label for=">Transgender"> Transgender</label>

                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <input type="text" name="preaddress" placeholder="Present address"
                                                    required="">

                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <input type="text" name="peraddress" placeholder="Permanant address"
                                                    required="">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label for="">Technical qualification</label>

                                                <select name="techqualification" id="techqualification">
                                                    <option value="iti">ITI</option>
                                                    <option value="diploma">Diploma</option>
                                                    <option value="bebtech">B.E/B.Tech</option>
                                                    <option value="memtech">ME/M.Tech</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <input type="text" name="discipline"
                                                    placeholder="Discipline of technical qualification" required="">

                                            </div>

                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <input type="text" name="workexperience" placeholder="Work Experience">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <input type="text" name="computerknowledge"
                                                    placeholder="Computer knowledge details." required="">

                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">

                                                <label for="qualification">Geographic area like to work</label>
                                                <select name="geographicalareawork" id="geographicalareawork">
                                                    <option value="panindia">PAN India</option>
                                                    <option value="anystate">Any State</option>
                                                    <option value="anydistrict">Any District</option>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label>Attach document of ID proof</label>
                                                <input type="file" name="fileToUpload" id="fileToUpload"
                                                    placeholder="Attach document of ID proof" required=""
                                                    accept="application/pdf,image/x-png,image/gif,image/jpeg">

                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label>Attach qualification document</label>
                                                <input type="file" name="Uploadfile"
                                                    placeholder=" Attach document of ID proof" required=""
                                                    accept="application/pdf,image/x-png,image/gif,image/jpeg">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                                <label>Attach Experience Certificate</label>
