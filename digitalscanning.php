                    ...
                    <div class="content-side right-sidebar col-lg-8 col-md-12 col-sm-12">
                        <div class="services-detail">
                            <div class="inner-box">
                                ...
                                <div class="image">
                                    <img src="img/digiscan.jpg" alt="">
                                </div>
                                <h3>Digital Scanning</h3>
                                <p>Convert paper documents to digital and store them in the document management system
                                    using document scanning tools in Document Locator. Document scanning provides an
                                    end-to-end approach for information management, from paper to paperless.
                                ...
                                <p>Paper documents, images, drawings - virtually anything on paper can be scanned as
                                    digital files. Electronic files take up less space, accelerate business processes,
                                    are more secure, and are easier to recover for business continuity.</p>
                                <p>
                                    Digital scanners can use laser light to scan an image. These scanners, while
                                    offering superb quality, are so expensive as to be beyond most budgets. The scanners
                                    that use conventional visible light are more affordable and, hence, far more
                                    popular.
